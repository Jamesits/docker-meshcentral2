...
RUN npm install --save --include=optional meshcentral@${MESHCENTRAL2_VERSION} \
	&& npm install --no-optional --save mongodb saslprep otplib@10.2.3 image-size node-rdpjs-2 archiver-zip-encrypted passport passport-azure-oauth2 jwt-simple nodemailer \
